...
const MobileDashBoardNav = () => {
  ...
  return (
    <>
        ...
        >
          <div className="p-4 border-b border-slate-700">
            <Link href="/dashboard" className="block">
              <Image src="/images/logo.webp" alt="logo" height={40} width={120} />
            </Link>
          </div>
      ...
      <main className="flex-grow pt-[7rem] transition-all duration-300 ease-in-out max-md:ml-0 md:ml-[6rem] md:[&[data-nav-expanded=true]]:ml-[16rem]">
        <header className="fixed top-0 left-0 right-0 z-40 bg-slate-900/95 backdrop-blur-sm border-b border-slate-700 p-4 md:hidden">
