      ...
      {toggle && (
        ...
        >
          ...
          <ul className={styles.dashboard__navlists}>
            ...
            <li className={styles.li}>
              <Link href="/dashboard/nocontent" className={styles.link}>
                <svg
                  className={styles.svg}
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 512"
                ...
                <p className={styles.p}>Team Blog</p>
              </Link>
            </li>
            <li className={styles.li}>
              <Link className={styles.link} href="/dashboard/nocontent">
      ...
      <main className={styles.innerdashboard__container}>
        ...
        <header className={styles.header}>
          ...
          <div className={styles.search_form}>
            ...
            <input className={styles.input} type="search" placeholder="search and Read Along..." />
          </div>
