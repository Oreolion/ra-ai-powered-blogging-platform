...
const DashboardNav = ({
  ...
  return (
    <div className="fixed top-0 left-0 h-full z-50">
      <nav
        className={`h-full bg-slate-900/95 backdrop-blur-sm border-r border-slate-700 transition-all duration-300 ${showNav ? "w-04" : "w-16"}`}
      >
        {!showNav && (
            ...
            <div className="flex-1 py-4">
              <div className="flex flex-col items-center gap-2 mb-6">
                <Link
                  ...
                  title="Homefeeds"
                >
                  <svg className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <button
                  ...
                  className="w-10 h-10 flex items-center justify-center rounded-lg text-slate-400 hover:text-red-400 hover:bg-slate-800 transition-colors"
                  title="Sign Out"
                >
            ...
            <div className="p-4 space-y-6 overflow-y-auto h-full pb-20">
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <svg
                    className={`w-4 h-4 fill-current text-slate-400 cursor-pointer transition-transform ${dropDown ? "rotate-180" : ""}`}
