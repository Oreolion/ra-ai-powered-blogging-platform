...
const DashboardNav = () => {
  return (
    ...
    <div className={`${styles.logo} ${styles.link}`}>
      <h3 className={styles.h3}>THE <span className={styles.span}>RA</span> BLOG</h3>
      <p className={styles.p}>The <span className={styles.span}>Read Along</span> Blog</p>
    </div>
    ...
    <ul className={styles.dashboard__navlists}>
      ...
      <li className={styles.li}>
        <Link className={styles.link} href="/dashboard/nocontent">
          <svg className={styles.svg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            <path
